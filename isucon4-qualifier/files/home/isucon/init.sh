...
mysql -h ${myhost} -P ${myport} -u ${myuser} ${mydb} -e "ALTER TABLE login_log ADD INDEX (user_id)"
mysql -h ${myhost} -P ${myport} -u ${myuser} ${mydb} -e "ALTER TABLE login_log ADD INDEX (ip)"
